import "./index.css";
import NewsletterFeature from "./components/NewsletterFeatures/NewsletterFeature";

function App() {
  return (
    <main className="min-h-screen flex justify-center p-4 font-[16px]">
      <div className="w-[375px] h-[850px] shadow-sm shadow-gray-600">
        <div className="h-[284px] rounded-b-2xl mb-8">
          <svg
        ...
        <div className="px-5 text-[#36384e] font-medium">
          <h1 className="text-4xl font-semibold mb-8 text-[#242742]">
            Stay updated!
          </h1>
          <p className="mb-6">
          ...
          <form action="" className="mt-8">
            ...
            <input
              className="bg-[#242742] text-white cursor-pointer py-4 text-center w-full shadow-sm rounded-lg mb-8"
              type="sumbit"
